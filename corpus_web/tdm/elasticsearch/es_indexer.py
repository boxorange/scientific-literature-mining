...
t = time()
paths = ['../archive/PMC', '../archive/Springer/articles', '../archive/Elsevier/articles', '../archive/IOP_JSON'] 
#paths = ['../archive/Springer/articles'] 
bulk(es, index_folder('tdm_index_2', paths), max_chunk_bytes=1024)
