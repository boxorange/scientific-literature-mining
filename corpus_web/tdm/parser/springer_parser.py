...
class SpringerParser(BaseParser):
	...
	def update_uid_list(self):
		...
		for filename in os.listdir(dir):
			...
			doi_list.append(self.parse(os.path.join(dir, filename)))
	...
	def parse_book_chapter(self, root, specials, refs, filename):
		''' Book Meta '''
	...
	def parse_article(self, root, specials, refs, filename):
		''' Journal Meta '''
	...
	def parse(self, xml_file):
		...
		if root.find('.//book-part-wrapper') is not None:
			ret = self.parse_book_chapter(root, specials, refs, output_filename)
		elif root.find('.//article') is not None:
			ret = self.parse_article(root, specials, refs, output_filename)
		else:
